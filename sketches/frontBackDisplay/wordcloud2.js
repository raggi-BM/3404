...
(function (global) {
  ...
  var WordCloud = function WordCloud(elements, options) {
    ...
    var drawBox = function drawBox(gx, gy, info, word, weight, distance, theta, rotateDeg, customFont, wordId) {
      ...
      var boxWidth = info.paddedWidth;
      var boxHeight = info.paddedHeight;
      ...
      var offsetY = info.paddedHeight - lowestGreenPixelY;
      ...
      var bufferHeight = boxHeight + 20; // Increase the buffer height by 20px
      var bufferTopOffset = 10; // Shift the buffer 10px up and extend it 10px down
      ...
      if (farthestGreenPixelRight > 0) {
        ...
        horizontalOffsetX = farthestGreenPixelLeft;
      }
