...
(function (global) {
  ...
  var WordCloud = function WordCloud(elements, options) {
    ...
    var drawText = function drawText(gx, gy, info, word, weight, distance, theta, rotateDeg, attributes, extraDataArray, customFont) {
    ...
    var putWord = function putWord(item) {
      var word, weight, attributes, customFont
      if (Array.isArray(item)) {
        word = item[0]
        weight = item[1]
        customFont = item[2]
      ...
      var info = getTextInfo(word, weight, rotateDeg, extraDataArray, customFont)
      ...
      var tryToPutWordAtPoint = function (gxy) {
        ...
        drawText(gx, gy, info, word, weight,
          (maxRadius - r), gxy[2], rotateDeg, attributes, extraDataArray, customFont)
        // log all attributes of the word
        // console.log('gx: ', gx, 'gy: ', gy, 'info: ', info, 'word: ', word, 'weight: ', weight, 'maxRadius: ', maxRadius, 'r: ', r, 'gxy: ', gxy, 'rotateDeg: ', rotateDeg, 'attributes: ', attributes, 'extraDataArray: ', extraDataArray);
